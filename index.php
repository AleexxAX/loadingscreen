...
<head>
	...
	<meta name="description" content="LoadingScreen By AleexxAX - Mancos Gaming" />
	<title>Mancos Gaming ~ Loading Screen</title>
	...
	<body>
	<div class="copyright">
		<p>AleexxAX Build - <?php echo date("Y ", time()); ?></p>
	</div>
    ...
    <div id="background"> 
		...
		<div class="server">         
            <ul id="server-list">
            	<li><img src="assets/images/home-icon.png" class="item" alt="Server Name" /> <span id="s-name">Mancos Gaming</span></li>		
                <li><img src="assets/images/screen-icon.png" class="item" alt="Game Mode" /> <span id="s-mode">TTT </span></li>
                <li><img src="assets/images/map-icon.png" class="item" alt="Map Name" /> <span id="s-map">TTT_kakariko</span></li>	
           	</ul>
		</div>
     	</div>
        <div id="right-items">
